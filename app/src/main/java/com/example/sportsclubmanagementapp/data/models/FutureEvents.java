...
public class FutureEvents {
    ...
    public FutureEvents(long id, long clubId, String name, String description, String location, String date, int radius, String sportType, long invites_id, long requests_id, long members_id ) {
        this.id = id;
        this.clubId = clubId;
        this.name = name;
